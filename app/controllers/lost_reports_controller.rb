class LostReportsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lost_report.save
        format.html { redirect_to lost_report_url(@lost_report), notice: "Lost report was successfully created." }
  ...
  def update
    respond_to do |format|
      if @lost_report.update(lost_report_params)
        format.html { redirect_to lost_report_url(@lost_report), notice: "Lost report was successfully updated." }
  ...
  private
    ...
    def lost_report_params
      params.require(:lost_report).permit(:name, :location, :date_lost)
    end
end
